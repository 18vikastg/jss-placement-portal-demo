    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-red-600 mx-auto mb-4"></div>
                    <p className="text-gray-600 font-medium">Loading JSS Placement Analytics Dashboard...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <div className="text-center p-3 bg-red-50 rounded-lg">
                        <div className="text-2xl font-bold text-red-600">{realTimeMetrics.activeInterviews}</div>
                        <div className="text-gray-600 text-sm">Active Interviews</div>
                    </div>
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                        <div className="text-2xl font-bold text-orange-600">{realTimeMetrics.todaysOffers}</div>
                        <div className="text-gray-600 text-sm">Today's Offers</div>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">{realTimeMetrics.weeklyOffers}</div>
                        <div className="text-gray-600 text-sm">Weekly Offers</div>
                    </div>
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">{realTimeMetrics.pendingApplications}</div>
                        <div className="text-gray-600 text-sm">Pending Apps</div>
                    </div>
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                        <div className="text-2xl font-bold text-purple-600">{realTimeMetrics.interviewsScheduled}</div>
                        <div className="text-gray-600 text-sm">Interviews Scheduled</div>
                    </div>
                    <div className="text-center p-3 bg-emerald-50 rounded-lg">
                        <div className="text-2xl font-bold text-emerald-600">{realTimeMetrics.offerAcceptanceRate}%</div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex space-x-3">
                            <button className="bg-white text-red-600 px-6 py-3 rounded-lg font-medium hover:bg-red-50 transition-colors flex items-center space-x-2 shadow-sm">
