        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-red-100 max-w-2xl mx-auto mb-8">
                            Find your perfect role from top companies hiring through JSSATE
                        </p>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-md text-center">
                        <div className="text-2xl font-bold text-blue-600">₹8.5L</div>
                ...
                {filteredJobs.length > 0 ? (
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        {filteredJobs.map((job, index) => (
                            <div key={job._id || index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
