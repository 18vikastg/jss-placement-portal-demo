...
import LinkFolioMain from '../linkfolio/LinkFolioMain'
...
const StudentDashboard = () => {
    ...
    const [showLinkFolio, setShowLinkFolio] = useState(false)
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                    <div>
                                        <p className="text-purple-100 text-sm mb-2">
                                            ✨ 5-step portfolio builder ✨ Professional showcase ✨ Alumni networking
                                        </p>
